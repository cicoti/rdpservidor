...
public class RemoteDesktopServer {
    ...
    public static void main(String[] args) {
        ...
        logger.info(
                ...
                currentConfig.getHandshakePort(),
                currentConfig.getControlPort()
        );
    ...
    private static void openConfigurationDialog() {
        try {
            ...
            logger.info(
                    "Configuração atual para abertura da tela | handshake={} | controle={}",
                    activeHandshakePort,
                    activeControlPort
            );
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                logger.info(
                        "Tela de configuração encerrada | handshakeAtual={} | controleAtual={}",
                        currentConfig.getHandshakePort(),
                        currentConfig.getControlPort()
                );
            });
